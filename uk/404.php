...
<!-- Mirrored from themephi.net/template/embumh/embum/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Jun 2025 08:53:55 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            <div class="body-wrapper">
                ...
                <!-- error area start -->
                <section class="eb-error-area">
                    <div class="eb-error-wrap">
                        <img src="assets/images/bg/404-shape-1.png" alt="" class="eb-error-shape-1">
                        <img src="assets/images/bg/404-shape-2.png" alt="" class="eb-error-shape-2">
                        <img src="assets/images/bg/404-shape-3.png" alt="" class="eb-error-shape-3">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-8 col-lg-10 col-11">
                                    <div class="eb-error-content text-center">
                                        <div class="eb-error-img">
                                            <img src="assets/images/bg/404.png" alt="">
                                        </div>
                                        <div class="eb-error-info">
                                            <h4>Oops! Page Can’t be Found.</h4>
                                            <p>Oops! it could be you or us, there is no page here. It might have been moved or deleted.</p>
                                            <a href="index-2.html">Go Back Home</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
