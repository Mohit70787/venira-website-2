                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-2 col-lg-2 col-6">
                                    <div class="eb_h2-header-logo">
                                        <a href="index.php"><img src="assets/img/logo/logo.jpg" class="w-50" alt=""></a>
                                    </div>
                                </div>
                                ...
                                <li class="menu-has-child">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li><a href="accounts-receivable-services.php">Accounts Receivable
                                                Services</a></li>
                                ...
                                <li class="menu-has-child">
                                    <a href="#">Software </a>
                                    <ul class="submenu">
                                        <li><a href="quickbook.php">QuickBook</a></li>
                                        <li><a href="xero.php">Xero</a></li>
                                        <li><a href="free-agent.php">Free Agent</a></li>
                                        <li><a href="fresh-book.php">Fresh Book</a></li>
                                        <li><a href="zoho.php">Zoho</a></li>
                                        <li><a href="wave.php">Wave</a></li>
                                        <li><a href="netsuit.php">Netsuit</a></li>
                                        <li><a href="sage.php">Sage</a></li>
                                        <li><a href="restaurant-365.php">Restaurant 365</a></li>
                                        <li><a href="bill-com.php">Bill Com</a></li>
                                    </ul>
                                </li>
                                ...
                                <div class="col-xl-3 col-lg-3 col-6">
                                    <div class="eb_h2-header-action">
                                        <a href="contact.php" class="eb_h3-theme-btn">Contact</a>
